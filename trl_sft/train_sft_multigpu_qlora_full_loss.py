#!/usr/bin/env python3
"""Multi-GPU QLoRA SFT with full-sequence causal LM loss."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="TRL QLoRA SFT with full-sequence loss.")
...
def main() -> None:
    try:
        ...
        maybe_login()
        if is_main_process():
            print(f"Starting full-loss QLoRA SFT: world_size={get_world_size()}, output_dir={args.output_dir}")
