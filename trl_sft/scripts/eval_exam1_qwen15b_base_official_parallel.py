#!/usr/bin/env python3
"""Multi-GPU official-style TimeSeriesExam1 evaluation for a base model.

Launch with accelerate or torchrun, for example:

  accelerate launch --num_processes 4 scripts/eval_exam1_qwen15b_base_official_parallel.py ...
...
DEFAULT_OUTPUT_FILE = "reports/timeseries_exam1_qwen15b_base_official_predictions_parallel.jsonl"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Parallel official-style TimeSeriesExam1 evaluation for a base Qwen2.5 model."
    )
